<?php
    ...
    //send email for merchant
    $to_email = 'to_email'; // fill in the email that you want to receive notifications
    $subject = 'Delivery Confirmation';
    $content = 'Your fullfillment for Order #' . $fulfillment['order_id'] . ' has been ' . $fulfillment['status'] . ' on ' . $fulfillment['created_at'];
